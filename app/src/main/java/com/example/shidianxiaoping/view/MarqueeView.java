package com.example.shidianxiaoping.view;
...
public class MarqueeView extends ViewFlipper {
    ...
    // 根据公告字符串列表启动轮播
    public void startWithList(Vector<String> notices) {
        isList = true;
        setNotices(notices);
        start();
    }
    ...
    public Vector<String> getNotices() {
        return notices;
    }

    public void setNotices(Vector<String> notices) {
